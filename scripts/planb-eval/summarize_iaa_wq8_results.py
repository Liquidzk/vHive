#!/usr/bin/env python3
"""Build a compact view of the fixed-CPU IAA-only 8-WQ matrix."""
...
def main() -> None:
    ...
    metadata = {}
    for line in (result_dir / "matrix.env").read_text().splitlines():
        key, value = line.split("=", 1)
        metadata[key] = value
    settings_count = len(metadata.get("iaa_settings", "1:1 2:2 4:4 8:8").split())
